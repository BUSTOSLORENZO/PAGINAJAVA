...
public class Deportes extends JFrame {
	...
	public Deportes() {
		...
		btnNewButton.setIcon(new ImageIcon(Deportes.class.getResource("/com/images/twitter_header_photo_2 (9).jpg")));
		...
		lblDeportes.setIcon(new ImageIcon(Deportes.class.getResource("/com/images/twitter_header_photo_2 (4).jpg")));
		...
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\Tita\\Downloads\\WhatsApp Image 2023-08-15 at 15.17.53.jpg"));
		lblNewLabel_5.setBounds(10, 11, 144, 129);
		panel_2.add(lblNewLabel_5);
		
		JLabel lblNewLabel_7 = new JLabel("Vuelve el jogo bonito");
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Deportes.class.getResource("/com/images/WhatsApp Image 2023-08-15 at 15.17.53.jpg")));
		...
		lblNewLabel_5_1_1.setIcon(new ImageIcon(Deportes.class.getResource("/com/images/ERRE DE PE (1).jpg")));
