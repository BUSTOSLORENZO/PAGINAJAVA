...
public class Noticiavarita extends JFrame {
	...
	public Noticiavarita() {
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(pagina.web.Noticiavarita.class.getResource("/com/images/WhatsApp Image 2023-08-15 at 15.17.53 (1).jpg")));
		...
		lblNewLabel_5.setIcon(new ImageIcon(Noticiavarita.class.getResource("/com/images/site_image logo ty (1).jpg")));
