...
public class Politica extends JFrame {
	...
	public Politica() {
		...
		btnNewButton.setIcon(new ImageIcon(Politica.class.getResource("/com/images/twitter_header_photo_2 (9) (1).jpg")));
		...
		lblDeportes.setIcon(new ImageIcon(Politica.class.getResource("/com/images/twitter_header_photo_2 (10) (1).jpg")));
		...
		JLabel lblElMundoDel = new JLabel("El mundo de la politica");
		...
		lblNewLabel_5.setIcon(new ImageIcon(Politica.class.getResource("/com/images/mieli (1) (1).jpg")));
		lblNewLabel_5.setBounds(0, 11, 144, 129);
		panel_2.add(lblNewLabel_5);
		
		JLabel lblNewLabel_7 = new JLabel("Sorpresa en Las Paso");
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Politica.class.getResource("/com/images/macri gobernador (1).jpg")));
		...
		JLabel lblNewLabel_8 = new JLabel("Nuevo jefe de gobierno\r\n");
		...
		lblNewLabel_5_1_1.setIcon(new ImageIcon(Politica.class.getResource("/com/images/descarga (1) (1).jpg")));
		lblNewLabel_5_1_1.setBounds(10, 11, 144, 129);
		panel_2_2.add(lblNewLabel_5_1_1);
		
		JLabel lblNewLabel_9 = new JLabel("Elecciones 2023");
