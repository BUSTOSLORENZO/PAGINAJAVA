...
public class Noticiaelecciones extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Noticiaelecciones frame = new Noticiaelecciones();
	...
	public Noticiaelecciones() {
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Noticiaelecciones.class.getResource("/com/images/elecciones resultados.jpg")));
		...
		txtrLaVentaDe.setText("LOS RESULTADOS DE\nLAS ELECCIONES 2023 ");
