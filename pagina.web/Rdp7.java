...
public class Rdp7 extends JFrame {
	...
	public Rdp7() {
		...
		btnNewButton.setIcon(new ImageIcon(Noticiavarita.class.getResource("/com/images/twitter_header_photo_2 (9) (1).jpg")));
		...
		lblDeportes.setIcon(new ImageIcon(Noticiavarita.class.getResource("/com/images/twitter_header_photo_2 (4) (1).jpg")));
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Rdp7.class.getResource("/com/images/RODRIIIII (1).jpg")));
		
		JTextArea txtrTextotextotextotextotextotextotextotextotextotextotexto = new JTextArea("En el mundo del fútbol, las historias de jugadores que regresan\n a sus clubes de origen suelen ser motivo de gran emoción y\n expectación entre los aficionados. En este contexto, los rumores\nsobre la posible vuelta de Rodrigo de Paul al Racing Club han\n encendido la llama de la esperanza en los corazones de los hinchas\n académicos.Luego de ser visto en Argentina y reunido con dirigentes\n del Club Atletico Racing y teniendo en cuenta que Rodrigo termina\n contrato con el club Atletico de Madrid en diciembre, se hace cada\n vez mas fuerte su llegada. ");
		...
		txtrLaVentaDe.setText("DE PAUL Y SU POSIBLE VUELTA\nAL CLUB DE SUS AMORES\r\r\n");
		...
		lblNewLabel_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					Desktop.getDesktop().browse(new URI ("https://www.ole.com.ar/"));
				} catch(Exception ex) {
					ex.printStackTrace();
				}
			}
		});
		lblNewLabel_5.setIcon(new ImageIcon(Rdp7.class.getResource("/com/images/ole logo.jpg")));
		lblNewLabel_5.setBounds(453, 247, 124, 55);
		panel_1.add(lblNewLabel_5);
		
		JLabel lblGastonEdul = new JLabel("Gonzalo Suli - 22/07/2023");
