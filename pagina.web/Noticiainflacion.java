...
public class Noticiainflacion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Noticiainflacion frame = new Noticiainflacion();
	...
	public Noticiainflacion() {
		...
		lblDeportes.setIcon(new ImageIcon(Noticiainflacion.class.getResource("/com/images/twitter_header_photo_2 (12) (1).jpg")));
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Noticiainflacion.class.getResource("/com/images/inflacion-subyacente (1).jpg")));
		...
		txtrLaVentaDe.setText("LA INFLACION ACUALMENTE\nEN ARGENTINA ");
