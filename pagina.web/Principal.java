...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		btnNewButton.setIcon(new ImageIcon(Principal.class.getResource("/com/images/twitter_header_photo_2 (9) (1).jpg")));
		...
		lblNewLabel = new JLabel("Politica");
		...
		lblDeportes.setIcon(new ImageIcon(Principal.class.getResource("/com/images/welcome.jpg")));
		...
		JLabel lblElMundoDel = new JLabel("Enterate de las ultimas noticias!!");
		...
		/*panel_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Vuelve el jogo bonito frame = new Vuelve el jogo bonito;
				frame.setVisible(true);
				dispose();
			}
		});*/
		...
		lblNewLabel_5.setIcon(new ImageIcon(Principal.class.getResource("/com/images/vartia 1.jpg")));
		lblNewLabel_5.setBounds(10, 11, 144, 129);
		panel_2.add(lblNewLabel_5);
		
		JLabel lblNewLabel_7 = new JLabel("Se despide Varita");
		...
		/*panel_2_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Las PASO 2023 frame = new Las PASO 2023;
				frame.setVisible(true);
				dispose();
			}
		});*/
		...
		lblNewLabel_5_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Noticiamilei frame = new  Noticiamilei();
				frame.setVisible(true);
				dispose();
			}
		});
		lblNewLabel_5_1.setIcon(new ImageIcon(Principal.class.getResource("/com/images/mieli (1) (1).jpg")));
		lblNewLabel_5_1.setBounds(10, 11, 144, 129);
		panel_2_1.add(lblNewLabel_5_1);
		
		JLabel lblNewLabel_8 = new JLabel("Las paso 2023");
		...
		lblNewLabel_5_1_1.setIcon(new ImageIcon(Principal.class.getResource("/com/images/9Zteam-portada (1) (1).jpg")));
		lblNewLabel_5_1_1.setBounds(10, 11, 144, 129);
		panel_2_2.add(lblNewLabel_5_1_1);
		
		JLabel lblNewLabel_9 = new JLabel("9Z y su nuevo torneo");
