...
public class Noticiamilei extends JFrame {
	...
	public Noticiamilei() {
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Noticiamilei.class.getResource("/com/images/Javier_Milei (1).jpg")));
		...
		txtrLaVentaDe.setText("JAVIER MILEI GANO\nLAS PASO 2023 ");
