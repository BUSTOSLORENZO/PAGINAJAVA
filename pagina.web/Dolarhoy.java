...
public class Dolarhoy extends JFrame {
	...
	public Dolarhoy() {
		...
		btnNewButton.setBounds(0, 0, 202, 98);
		btnNewButton.setBackground(new Color(255, 255, 255));
		panel.add(btnNewButton);
		btnNewButton.setBorder(null);
		btnNewButton.setIcon(new ImageIcon(Dolarhoy.class.getResource("/com/images/twitter_header_photo_2 (9) (1).jpg")));
		...
		lblDeportes.setIcon(new ImageIcon(Dolarhoy.class.getResource("/com/images/twitter_header_photo_2 (12) (1).jpg")));
		...
		JLabel lblElMundoDel = new JLabel("La economia del pais");
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Dolarhoy.class.getResource("/com/images/dolar (1) (6).jpg")));
		
		JTextArea txtrTextotextotextotextotextotextotextotextotextotextotexto = new JTextArea("Hoy en dia contamos con el dolar oficial a un precio de compra\nde $347,50 y un precio de venta de $365,50 mientras que el dolar blue\n lo encontramos a un precio de compra de $715\n y un precio de venta de $725. ");
		...
		txtrTextotextotextotextotextotextotextotextotextotextotexto.setBounds(10, 78, 371, 148);
		...
		txtrLaVentaDe.setText("A CUANTO ESTA EL DOLAR HOY\r\r\n");
		txtrLaVentaDe.setBounds(10, 0, 371, 67);
		...
		txtrSss_1.setText("https://twitter.com/gaelfernandez\nhttps://www.instagram.com/gaelfernandez\nhttps://www.twitch.tv/gaelfernandez");
		...
		JLabel lblGastonEdul = new JLabel("Gael Fernandez - 06/09/2023");
