...
public class Noticiavarita extends JFrame {
	...
	public Noticiavarita() {
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(Noticiavarita.class.getResource("/com/images/WhatsApp Image 2023-08-15 at 15.17.53 (1).jpg")));
		
		JTextArea textArea_1 = new JTextArea("Unas de las estrellas de la Asociacion Atletica Argentinos Juniors\nfue vendido al Club Atletico Real Madrid\nLuego de varias charlas de negociaciones El Bicho acepto la oferta\npresentada y Tiago 'Varita' Digon se ira a jugar con los Merengues.\nEl pivot jugo su ultimo partido el anterior finde semana y ya paso\npor la concentracion del club para despedirse de sus excompañeros\n\n\nEXITOS VARITA!!  ");
		textArea_1.setForeground(new Color(255, 255, 255));
		textArea_1.setBackground(new Color(128, 128, 128));
		textArea_1.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		textArea_1.setBounds(10, 78, 363, 148);
        textArea_1.setEditable(false);
		panel_1.add(textArea_1);
		
		JLabel lblI = new JLabel("Ultima partido jugado en AAAJ");
		...
		lblI.setFont(new Font("Segoe UI", Font.BOLD, 10));
		lblI.setBackground(Color.WHITE);
		lblI.setBounds(383, 194, 204, 45);
		panel_1.add(lblI);
		...
		txtrLaVentaDe.setText("LA VENTA DE UNA JOYITA\nDEL CLUB");
		...
		JLabel lblElMundoDel_1 = new JLabel("El mundo del futbol");
		lblElMundoDel_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				
				try {
					Desktop.getDesktop().browse(new URI ("https://www.tycsports.com/"));
				} catch(Exception ex) {
					ex.printStackTrace();
				}
		...
		lblElMundoDel_1.setIcon(new ImageIcon(Noticiavarita.class.getResource("/com/images/site_image (1).jpg")));
		lblElMundoDel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblElMundoDel_1.setForeground(Color.WHITE);
		lblElMundoDel_1.setFont(new Font("Segoe UI", Font.BOLD, 20));
		lblElMundoDel_1.setBackground(Color.WHITE);
		lblElMundoDel_1.setBounds(448, 250, 139, 50);
		panel_1.add(lblElMundoDel_1);
		...
		separator_3.setBounds(413, 223, 148, 2);
