...
public class Varita extends JFrame {
	...
	public Varita() {
		...
		btnNewButton.setIcon(new ImageIcon(Varita.class.getResource("/com/images/twitter_header_photo_2 (9) (1).jpg")));
		...
		lblDeportes.setIcon(new ImageIcon(Varita.class.getResource("/com/images/twitter_header_photo_2 (4) (1).jpg")));
		...
		lblNewLabel_7.setIcon(new ImageIcon(Varita.class.getResource("/com/images/AAAJJJJ (1).jpg")));
		lblNewLabel_7.setBounds(453, 247, 124, 55);
		panel_1.add(lblNewLabel_7);
		
		JLabel lblGastonEdul_1 = new JLabel("26/08/2023\r\n");
		lblGastonEdul_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblGastonEdul_1.setForeground(Color.WHITE);
		lblGastonEdul_1.setFont(new Font("Segoe UI", Font.BOLD, 13));
		lblGastonEdul_1.setBackground(Color.WHITE);
		lblGastonEdul_1.setBounds(459, 202, 150, 44);
		panel_1.add(lblGastonEdul_1);
		
		JLabel lblGastonEdul = new JLabel("Comunicado oficial del club");
		...
		lblGastonEdul.setBounds(553, 97, 258, 50);
