...
public class Esports extends JFrame {
	...
	public Esports() {
		...
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\Tita\\Downloads\\twitter_header_photo_2 (9).jpg"));
		...
		lblDeportes.setIcon(new ImageIcon("C:\\Users\\Tita\\Downloads\\twitter_header_photo_2 (11).jpg"));
		...
		JLabel lblElMundoDel = new JLabel("Noticias sobre los videojuegos");
		...
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\Tita\\Downloads\\9Zteam-portada (1).jpg"));
		lblNewLabel_5.setBounds(10, 11, 144, 129);
		panel_2.add(lblNewLabel_5);
		
		JLabel lblNewLabel_7 = new JLabel("9Z y su nuevo torneo");
		...
		lblNewLabel_5_1.setIcon(new ImageIcon("C:\\Users\\Tita\\Downloads\\KRU-ESPORTS-VCT-AMERICA.jpg"));
		lblNewLabel_5_1.setBounds(10, 11, 144, 129);
		panel_2_1.add(lblNewLabel_5_1);
		
		JLabel lblNewLabel_8 = new JLabel("La  figura de KRU");
		...
		lblNewLabel_5_1_1.setIcon(new ImageIcon("C:\\Users\\Tita\\Downloads\\descarga (2).jpg"));
		lblNewLabel_5_1_1.setBounds(10, 11, 144, 129);
		panel_2_2.add(lblNewLabel_5_1_1);
		
		JLabel lblNewLabel_9 = new JLabel("Bestia y sus Sponsors");
